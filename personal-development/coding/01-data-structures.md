...
A graph data structure is a collection of nodes that have data and are connected to other nodes.  Graph is a non-linear data structure consisting of vertices and edges. The data structure (V, E) consists of:
